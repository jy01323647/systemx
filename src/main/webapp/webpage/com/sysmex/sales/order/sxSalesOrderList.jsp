...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="sxSalesOrderList" checkbox="false" pagination="true" fitColumns="false" title="销售订单表" actionUrl="sxSalesOrderController.do?datagrid"
   ...
   <t:dgToolBar title="录入" icon="fa fa-plus" url="sxSalesOrderController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="fa fa-edit" url="sxSalesOrderController.do?goUpdate" funname="update"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="fa fa-trash-o" url="sxSalesOrderController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="fa fa-file-text-o" url="sxSalesOrderController.do?goUpdate" funname="detail"></t:dgToolBar>
