...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="taaediInvoiceMainController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="vendorNum" name="vendorNum" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${taaediInvoiceMainPage.vendorNum}'/>
			...
			<td class="value">
		     	 <input id="vendorName" name="vendorName" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${taaediInvoiceMainPage.vendorName}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="invioceNo" name="invioceNo" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${taaediInvoiceMainPage.invioceNo}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
					  <input id="invioceDate" name="invioceDate" type="text" style="width: 150px"   ignore="ignore"  value='<fmt:formatDate value='${taaediInvoiceMainPage.invioceDate}' type="date" pattern="yyyy-MM-dd"/>'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="remarkFlag" name="remarkFlag" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore"  value='${taaediInvoiceMainPage.remarkFlag}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="memo" name="memo" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${taaediInvoiceMainPage.memo}'/>
				<span class="Validform_checktip"></span>
			...
			<div style="width: auto;height: 200px;">
				...
				<t:tabs id="tt" iframe="false" tabPosition="top" fit="false">
				 <t:tab href="taaediInvoiceMainController.do?taaediInvoiceDetailList&invioceNo=${taaediInvoiceMainPage.invioceNo}" icon="icon-search" title="发票明细信息" id="taaediInvoiceDetail"></t:tab>
				 <t:tab href="taaediInvoiceMainController.do?taaediInvoicePackDetailList&&invioceNo=${taaediInvoiceMainPage.invioceNo}" icon="icon-search" title="箱单明细信息" id="taaediInvoicePackDetail"></t:tab>
				</t:tabs>
			</div>
			</t:formvalid>
			<!-- 添加 附表明细 模版 -->
		...
		<tbody id="add_taaediInvoiceDetail_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  <td align="left">
					  		<input name="taaediInvoiceDetailList[#index#].invioceNo" maxlength="50" type="text" class="inputxt"  style="width:120px;"  ignore="ignore" />
