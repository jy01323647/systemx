  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="taaediOrderMainController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="mmBillNo" name="mmBillNo" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${taaediOrderMainPage.mmBillNo}'/>
		...
		<tbody id="add_taaediOrderDetail_table_template">
			<tr>
			 ...
			 <td align="center"><input style="width:20px;" type="checkbox" name="ck"/></td>
				  ...
				  <td align="left">
							<input name="taaediOrderDetailList[#index#].ppArrivalDate" maxlength="32" type="text" class="Wdate" onClick="WdatePicker()"  style="width:120px;"  ignore="ignore" />
