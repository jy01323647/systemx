  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="taaediDeclarationMainController.do?doUpdate" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		...
		<tr>
			...
			<td class="value">
		     	 <input id="tamount" name="tamount" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${taaediDeclarationMainPage.tamount}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="consignee" name="consignee" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${taaediDeclarationMainPage.consignee}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="licenceNo" name="licenceNo" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${taaediDeclarationMainPage.licenceNo}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="status" name="status" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${taaediDeclarationMainPage.status}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="taxBill" name="taxBill" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${taaediDeclarationMainPage.taxBill}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="impList" name="impList" type="text" style="width: 150px" class="inputxt"  ignore="ignore"  value='${taaediDeclarationMainPage.impList}'/>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="attachmentFlag" name="attachmentFlag" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore"  value='${taaediDeclarationMainPage.attachmentFlag}'/>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="remarkFlag" name="remarkFlag" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore"  value='${taaediDeclarationMainPage.remarkFlag}'/>
				<span class="Validform_checktip"></span>
