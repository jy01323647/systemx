...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="taaediDeclarationMainList" checkbox="true" fitColumns="false" title="报关单主表" actionUrl="taaediDeclarationMainController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="报关状态"  field="status"  queryMode="single" hidden="true" width="120"></t:dgCol>
   <t:dgCol title="报关单"  field="customsBill"  queryMode="single" hidden="true" width="120"></t:dgCol>
   <t:dgCol title="税单"  field="taxBill"  queryMode="single" hidden="true" width="120"></t:dgCol>
   <t:dgCol title="进岸清单"  field="impList"  queryMode="single" hidden="true" width="120"></t:dgCol>
   <t:dgCol title="是否紧急标志"  field="urgentFlag"  queryMode="single" hidden="true" width="120"></t:dgCol>
   <t:dgCol title="附件标志"  field="attachmentFlag"  queryMode="single" hidden="true" width="120"></t:dgCol>
   <t:dgCol title="备注"  field="memo"  queryMode="single" hidden="true" width="120"></t:dgCol>
