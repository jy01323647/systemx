...
public class TaaediDeclarationPackDetailEntity implements java.io.Serializable {
	...
	private java.math.BigDecimal packQuantity;
	/**包装规格*/
	...
	private java.math.BigDecimal poQuantity;
	/**单价*/
	...
	/**
	 *方法: 取得java.math.BigDecimal
	 *@return: java.math.BigDecimal  箱单数量
	 */
	
	@Column(name ="PACK_QUANTITY",nullable=true,scale=3,length=20)
	public java.math.BigDecimal getPackQuantity(){
		return this.packQuantity;
	}

	/**
	 *方法: 设置java.math.BigDecimal
	 *@param: java.math.BigDecimal  箱单数量
	 */
	public void setPackQuantity(java.math.BigDecimal packQuantity){
	...
	/**
	 *方法: 取得java.math.BigDecimal
	 *@return: java.math.BigDecimal  订单数量
	 */
	
	@Column(name ="PO_QUANTITY",nullable=true,scale=3,length=20)
	public java.math.BigDecimal getPoQuantity(){
		return this.poQuantity;
	}

	/**
	 *方法: 设置java.math.BigDecimal
	 *@param: java.math.BigDecimal  订单数量
	 */
	public void setPoQuantity(java.math.BigDecimal poQuantity){
