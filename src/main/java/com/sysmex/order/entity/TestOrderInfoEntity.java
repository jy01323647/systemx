 ...
 */
@Entity
@Table(name = "test_order_info", schema = "")
@SuppressWarnings("serial")
public class TestOrderInfoEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="ORDER_COUNT",nullable=true,length=11)
	...
	@Column(name ="ORDER_PIRCE",nullable=true,scale=2,length=32)
