 ...
 * @date 2017-12-07 11:34:53
 * @version V1.0   
 *
 */
@Entity
@Table(name = "test_order_detail_info", schema = "")
@SuppressWarnings("serial")
public class TestOrderDetailInfoEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 *@return: java.lang.Integer  物料数量
	 */
	
	@Column(name ="PRODUCT_COUNT",nullable=true,length=11)
