...
/**   
 * @Title: Entity
 * @Description: TaaediInvoicePackDetail
 ...
 */
@Entity
@Table(name = "taaedi_invoice_pack_detail", schema = "")
@SuppressWarnings("serial")
public class TaaediInvoicePackDetailEntity implements java.io.Serializable {
	/**主键*/
	...
	/**订单数量*/
	private java.lang.String poQuantity;
	/**单价*/
	private java.lang.String unitPrice;
	/**订单总金额*/
	private java.lang.String totalAmount;
	/**预计到货日期*/
	private java.util.Date planArrivalDate;
	/**订单类型*/
	...
	@Column(name ="PACK_QUANTITY",nullable=true,scale=3,length=20)
	...
	/**
	 *方法: 取得java.lang.String
	 *@return: java.lang.String  订单数量
	 */
	
	@Column(name ="PO_QUANTITY",nullable=true,scale=3,length=20)
	public java.lang.String getPoQuantity(){
		return this.poQuantity;
	}

	/**
	 *方法: 设置java.lang.String
	 *@param: java.lang.String  订单数量
	 */
	public void setPoQuantity(java.lang.String poQuantity){
	...
	@Column(name ="PLAN_ARRIVAL_DATE",nullable=true,length=32)
	 ...
	 */
	public void setPlanArrivalDate(java.util.Date planArrivalDate){
	...
	@Column(name ="URGENT_FLAG",nullable=true,length=32)
